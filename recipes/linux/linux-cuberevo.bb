DESCRIPTION = "Linux kernel for Cuberevo"
LICENSE = "GPL"
PN = "linux-cuberevo"
#KV = "2.6.17"
KV = "2.6.23"
...
SRC_URI_stm22 += "\
	...
	file://cuberevo_setup_p0041.patch;patch=1 \
	file://cuberevo_defconfig"
...
SRC_URI += "\
	...
	file://cuberevo_setup_stlinux23_0123.patch;patch=1 \
	file://cuberevo_defconfig"

do_configure_prepend () {
	oe_machinstall -m 0644 ${WORKDIR}/cuberevo_defconfig ${S}/.config
