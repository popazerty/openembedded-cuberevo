DESCRIPTION = "Linux kernel for Cuberevo-2000hd"
LICENSE = "GPL"
PN = "linux-cuberevo-2000hd"
#KV = "2.6.17"
KV = "2.6.23"
#PV = "2.6.17"
PV = "2.6.23"
...
SRC_URI_stm22 += "\
	...
	file://cuberevo-2000hd_setup_p0041.patch;patch=1 \
	file://cuberevo-2000hd_defconfig"
...
SRC_URI += "\
	...
	file://cuberevo-2000hd_setup_stlinux23_0123.patch;patch=1 \
	file://cuberevo-2000hd_defconfig"

do_configure_prepend () {
	oe_machinstall -m 0644 ${WORKDIR}/cuberevo-2000hd_defconfig ${S}/.config
