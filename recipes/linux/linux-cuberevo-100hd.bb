DESCRIPTION = "Linux kernel for Cuberevo-100hd"
LICENSE = "GPL"
PN = "linux-cuberevo-100hd"
#KV = "2.6.17"
KV = "2.6.23"
#PV = "2.6.17"
PV = "2.6.23"
...
SRC_URI_stm22 += "\
	...
	file://cuberevo-100hd_setup_p0041.patch;patch=1 \
	file://cuberevo-100hd_defconfig"
...
SRC_URI += "\
	...
	file://cuberevo-100hd_setup_stlinux23_0123.patch;patch=1 \
	file://cuberevo-100hd_defconfig"

do_configure_prepend () {
	oe_machinstall -m 0644 ${WORKDIR}/cuberevo-100hd_defconfig ${S}/.config
