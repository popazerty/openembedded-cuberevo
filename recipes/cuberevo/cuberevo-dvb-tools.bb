...
do_configure_prepend() {
        ...
        install -m 0644 ${WORKDIR}/showiframe.c ${S}/showiframe/
        install -m 0644 ${WORKDIR}/showiframe.pro ${S}/showiframe/
}
...
#       install -m 0755 ${WORKDIR}/showiframe ${D}/${bindir}/
        ...
        [ ! -f "${STAGING_DIR}/${HOST_SYS}/lib/libeplayer3.so.0" ] && ln -s libeplayer3.so.0.0.0 ${STAGING_DIR}/${HOST_SYS}/lib/libeplayer3.so.0
        [ ! -f "${STAGING_DIR}/${HOST_SYS}/lib/libeplayer3.so" ] && ln -s libeplayer3.so.0.0.0 ${STAGING_DIR}/${HOST_SYS}/lib/libeplayer3.so
        install -m 0755 ${WORKDIR}/libmmeimage.so.0.0.0 ${STAGING_DIR}/${HOST_SYS}/lib/libmmeimage.so.0.0.0
        [ ! -f "${STAGING_DIR}/${HOST_SYS}/lib/libmmeimage.so.0" ] && ln -s libmmeimage.so.0.0.0 ${STAGING_DIR}/${HOST_SYS}/lib/libmmeimage.so.0
        [ ! -f "${STAGING_DIR}/${HOST_SYS}/lib/libmmeimage.so" ] && ln -s libmmeimage.so.0.0.0 ${STAGING_DIR}/${HOST_SYS}/lib/libmmeimage.so
        ...
        install -m 0755 ${WORKDIR}/libdvbsi++.so.0.0.0 ${D}/usr/lib/libdvbsi++.so.0.0.0
